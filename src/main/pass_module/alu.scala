...
class ALU extends Module {
  ...
  switch(io.Sub_OP_out) {
    ...
    is(ALUOps.ALU_ADDW) { io.Insn_rdresult := (io.Insn_operand1(31, 0).asSInt + io.Insn_operand2(31, 0).asSInt).pad(64).asUInt }
    is(ALUOps.ALU_SUBW) {  io.Insn_rdresult := (io.Insn_operand1(31, 0).asSInt - io.Insn_operand2(31, 0).asSInt).pad(64).asUInt }
    is(ALUOps.ALU_SLLW) { io.Insn_rdresult := (io.Insn_operand1(31, 0) << io.Insn_operand2(4, 0)).pad(64).asUInt }
    is(ALUOps.ALU_SRLW) { io.Insn_rdresult := (io.Insn_operand1(31, 0).asUInt >> io.Insn_operand2(4, 0)).pad(64).asUInt }
    is(ALUOps.ALU_SRAW) { io.Insn_rdresult := (io.Insn_operand1(31, 0).asSInt >> io.Insn_operand2(4, 0)).pad(64).asUInt }
