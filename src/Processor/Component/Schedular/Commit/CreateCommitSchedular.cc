#include "CreateCommitSchedular.hh"
        ...
        std::shared_ptr<Rcu> rcu)
{
    ...
    case IssuePolicy_t::InOrder :
        return std::make_shared<CMT_InOrder>(Name,SchedularId,EntryCount,EnqueWidth,DequeWidth,rcu);
        break;
    case IssuePolicy_t::InAgeOrder:
        return std::make_shared<CMT_InAgeOrder>(Name,SchedularId,EntryCount,EnqueWidth,DequeWidth,rcu);
        break;
    case IssuePolicy_t::OutofOrder:
        return std::make_shared<CMT_OutOfOrder>(Name,SchedularId,EntryCount,EnqueWidth,DequeWidth,rcu);
        break;
    default:
